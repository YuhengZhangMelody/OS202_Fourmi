...
class Pheromon:
    ...
    def update_with(self, the_pheromon):
        self.pheromon = the_pheromon
    ...
    # def examine(self):
    #     res = False
    #     for i in range(self.pheromon.shape[0]):
    #         for j in range(self.pheromon.shape[1]):
    #             if self.getColor(i, j)[0]:
    #                 print(i, j, self.pheromon[i, j])
    #                 res = True
